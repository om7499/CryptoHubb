...
let strokecolor=fistPrice>=lastPrice?"Orange":"yellow"
  ...
  return (
    <div className='col-12 col-sm-12 col-md-4 col-lg-4'>
      <div   className='card border border-success shadow p-3 placeholder-glow' style={{width:"100%",height:"400px"}} >
